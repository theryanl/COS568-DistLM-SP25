...
def train(args, train_dataset, model, tokenizer):
    ...
    epoch_loss_file = os.path.join(args.output_dir, f"2b_epoch_loss_node_{args.local_rank}.txt")
    step_loss_file = os.path.join(args.output_dir, f"2b_step_loss_node_{args.local_rank}.txt")
    ...
    plt.grid(True)
    plt.tight_layout()
    step_loss_fig_path = os.path.join(args.output_dir, f"2b_step_loss_node_{args.local_rank}.png")
